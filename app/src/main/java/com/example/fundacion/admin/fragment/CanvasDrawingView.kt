...
class CanvasDrawingView(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {

    private var clickGame: Game? = null
    private val cellSize = 100 // Tamaño de cada celda
    private val gridSize = 8 // Tamaño de la cuadrícula (5x5 en este ejemplo)
    //private val vowels = listOf('A', 'E', 'I', 'O', 'U') // Lista de vocales en mayúsculas
    private val vowels = listOf('a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z') // Lista de vocales en mayúsculas
